...
const Points = () => {
  ...
  const [initialPosition, setInitPosition] = useState<[number, number]>([0, 0]);
        ...
        <View style={styles.mapContainer}>
          { initialPosition[0] !== 0 && (
            <MapView style={styles.map} loadingEnabled={initialPosition[0] === 0} initialRegion={{latitude:initialPosition[0],longitude:initialPosition[1], latitudeDelta:0.014,longitudeDelta:0.014}}>
              ...
              {points.map(point => (
                <Marker key={String(point.id)} style={styles.mapMarker} coordinate={{latitude:point.lati,longitude:point.long}} onPress={() => handleNavigateToDetail(point.id)}>
